    ...
    <section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
      <div class="container">
        <div class="d-sm-flex flex-sm-row-reverse align-items-center">
          <img src="https://i.scdn.co/image/63cad86cb183568085a4e5f0be86aa187cc511e4" class="img-fluid" width="300" />
          <div>
...
<!-- article end -->
    ...
    <section id="aboutme" class="text-center p-5 bg-danger-subtle">
      <div class="container">
        <div class="d-sm-flex align-items-center justify-content-center">
          <div class="p-3">
            <img
              src="https://i.scdn.co/image/63cad86cb183568085a4e5f0be86aa187cc511e4"
              class="rounded-circle border shadow"
              width="300"
            />
          </div>
          <div class="p-md-5 text-sm-start">
            <h3 class="lead">A11.2023.14890</h3>
            <h1 class="fw-bold">Yobby Azriel Iqdhi Vianta</h1>
    ...
    <footer id="footer" class="text-center p-5">
      <div>
        ...
        ></a>
        <a href="https://wa.me/+6282135816573"
          ><i class="bi bi-whatsapp h2 p-2"></i
        ></a>
      </div>
      <div>Yobby Azriel Iqdhi Vianta &copy; 2024</div>
    </footer>
    <!-- footer end -->
